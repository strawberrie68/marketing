...
const Testimonial = () => {
    return (
        <article
            ...
            aria-label="Testimonial by Sarah Dole"
        >
            <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-px overflow-hidden">
                    <span className="font-semibold text-lg text-justify text-neutral-900 truncate">Sarah Dole</span>
                    <span className="font-normal text-sm text-neutral-600 truncate">@sarahdole</span>
                </div>
            </div>
            <blockquote>
